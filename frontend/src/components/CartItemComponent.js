...
const CartItemComponent = ({ item, removeFromCartHandler = false, orderCreated = false, changeCount = false }) => {
  return (
    <>
      <ListGroup.Item>
        <Row>
          {/* when screen size larger than tablet, occupy 2 grid of parent, small than that, 12 grid  */}
          <Col md={2}>
            <Image
          ...
          <Col md={3}>
            {/*the parameter to removefrom cart component is the para from this function */}
