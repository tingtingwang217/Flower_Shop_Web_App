...
const HeaderComponent = () => {
  ...
  return (
    <Navbar className="head" collapseOnSelect expand="lg" variant="dark">
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand href="/">SARA'S FLOWER SHOP</Navbar.Brand>
        </LinkContainer>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" />
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            <InputGroup>
              <DropdownButton id="dropdown-basic-button" title={searchCategoryToggle} className="dropDown" variant="secondary">
                  <Dropdown.Item onClick={() => setSearchCategoryToggle("All")}>All</Dropdown.Item>
                  {/*map through all categories in drop down menu */}
              ...
              <Button  className="searchButton" onClick={submitHandler} variant="secondary">
